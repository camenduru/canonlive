...
namespace canonlive
{
    class cameraControl
    {
        ...
        public static string PicDest = "C:\\pic\\";
        ...
        public static uint FocusON(IntPtr[] camera, int Count)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                success = EDSDK.EdsSendCommand(camera[i], EDSDK.CameraCommand_DoEvfAf, 1);  //Focus ON
                if (success != EDSDK.EDS_ERR_OK)
                {
                    Console.WriteLine("Fail to focus on,camera num is:" + i.ToString()
                                                         + "\t" + success.ToString());
                    err = (uint)i;
                }
            }
        ...
        public static uint FocusFar3(IntPtr[] camera, int Count)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                success = EDSDK.EdsSendCommand(camera[i], EDSDK.CameraCommand_DriveLensEvf, (int)EDSDK.EvfDriveLens_Far3);  //Focus
                if (success != EDSDK.EDS_ERR_OK)
                {
                    Console.WriteLine("Fail to focus far3,camera num is:" + i.ToString()
                                                         + "\t" + success.ToString());
                    err = (uint)i;
                }
            }
        ...
        public static uint FocusNear3(IntPtr[] camera, int Count)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                success = EDSDK.EdsSendCommand(camera[i], EDSDK.CameraCommand_DriveLensEvf, (int)EDSDK.EvfDriveLens_Near3);  //Focus
                if (success != EDSDK.EDS_ERR_OK)
                {
                    Console.WriteLine("Fail to focus near3,camera num is:" + i.ToString()
                                                         + "\t" + success.ToString());
                    err = (uint)i;
                }
            }
        ...
        public static uint FocusOFF(IntPtr[] camera, int Count)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                success = EDSDK.EdsSendCommand(camera[i], EDSDK.CameraCommand_DoEvfAf, 0);  //Focus OFF
                if (success != EDSDK.EDS_ERR_OK)
                {
                    Console.WriteLine("Fail to focus off,camera num is:" + i.ToString()
                                                         + "\t" + success.ToString());
                    err = (uint)i;
                }
            }
        ...
        public unsafe static Bitmap DownloadEvf(IntPtr Camera)
        {
            ...
            //            while (true)
            {
                ...
                //int _width = 1326, _height = 884; // from canon remote live
                int _width = 960, _height = 640;
                _newbmp = new Bitmap(_width, _height);
